  ...
  return (
    <div className='w-80 bg-slate-300 rounded-xl p-2'>
          ...
          <div className='flex gap-2 justify-center '>
                ...
                <button type="submit" name='action' value={"add-subtodo"}
                className='bg-black text-white p-2 rounded-xl'>Add</button>
            </div>
        ...
        <input type='hidden' name="completed" value={`${subTodo.completed}`}/>
      <button type="submit" name='action'  value="toggle-subTodo"  className='ml-3'
      onChange={(e)=> {
        e.preventDefault()
        submit(e.currentTarget , {replace:true})
      }} >
        <input type="checkbox" name="" id="" checked={subTodo.completed} />
      </button>
      </Form>
