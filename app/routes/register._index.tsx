...
export async function action({request}: ActionFunctionArgs){
  ...
  if(user){
    ...
    return json(await authenticator.authenticate("form", request, {
      successRedirect : '/',
...
const Register = () => {
  ...
  return (
    <div>
        ...
        <input type="text" name="name" className='bg-slate-100 p-2 rounded-xl'
            id="" placeholder='name' required/>
            <input type="text" name="username" className='bg-slate-100 p-2 rounded-xl'
            id="" placeholder='username' required/>

            <input type="password"  name="password" className='bg-slate-100 p-2 rounded-xl'
